...
(dept_no varchar(20),dept_name varchar(250));
...
create table titles
(title_id varchar(20), title varchar(250));
 alter table titles
...
---add relationships
ALTER TABLE dept_emp_numbers ADD CONSTRAINT fk_dept_emp_dept_no FOREIGN KEY(dept_no)
REFERENCES departments (dept_no);

ALTER TABLE dept_emp_numbers ADD CONSTRAINT fk_dept_emp_emp_no FOREIGN KEY(emp_no)
REFERENCES employees (emp_no);

ALTER TABLE "dept_manager" ADD CONSTRAINT "fk_dept_manager_dept_no" FOREIGN KEY("dept_no")
REFERENCES "department" ("dept_no");

ALTER TABLE "managers" ADD CONSTRAINT "fk_dept_manager_emp_no" FOREIGN KEY("emp_no")
REFERENCES "employees" ("emp_no");
...
--select views 
select * from vw_emp_salary --1
select * from vw_emp_hired_1986 --2
select * from vw_dept_managers --3
select * from departament_view --4
select * from vw_emp_hercules_b --5
select * from vw_emp_sales_dept --6
select * from vw_emp_sales_dev_dept --7
select * from vw_emp_last_name_freq --8
-- Bonus (Optional)
